...
function Footer() {
  ...
  return (
    <>
      <div className=" border-t-[5px] border-black p-5 text-white flex w-screen h-auto">
           ...
           ">
            ...
            <div className="p-2">
              ...
              smx:text-xl smx:p-2 w-full
                ...
                4xl:text-base 4xl:p-2
                ">
                  EMAIL : viveksharma8481@gmail.com
                  <br />
                  LINKDIN : https://www.linkedin.com/in/vivek-9b107730a/
                  <br />
                  GITHUB : https://github.com/Vivek850
                </p>
            </div>
          </div>
